...
<body>
    ...
    <?php if (session()->get('diskon_nominal')): ?>
      <div class="alert alert-success text-center m-3 mb-0" role="alert" style="border-radius: 0; font-weight: bold;">
        🎉 Hari ini ada diskon <?= number_to_currency(session()->get('diskon_nominal'), 'IDR') ?> per item!
      </div>
    <?php endif; ?>
